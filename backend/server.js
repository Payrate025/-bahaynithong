    ...
    try {
      await mailer.sendMail({
        ...
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f9f9f9;padding:24px;border-radius:10px">
          <h2 style="color:#1a3a2a">New Booking — ${source==="ai"?"🤖 AI Chat":source==="modal"?"🌐 Website":"👤 Manual"}</h2>
          <table style="width:100%;font-size:14px;border-collapse:collapse">
            <tr><td style="padding:6px 0;color:#666;width:150px">Booking Ref</td><td><strong style="color:#c9a84c">${bookingRef}</strong></td></tr>
            <tr><td style="padding:6px 0;color:#666">Guest</td><td><strong>${name}</strong></td></tr>
            ...
            <tr><td style="padding:6px 0;color:#666">Downpayment</td><td><strong style="color:#c9a84c">₱${downpayment.toLocaleString()}</strong></td></tr>
            <tr><td style="padding:6px 0;color:#666">Notes</td><td>${notes||"—"}</td></tr>
          </table>
        </div>`
      });
    ...
    if (email) {
      try {
        await mailer.sendMail({
          ...
          html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f9f9f9;padding:24px;border-radius:10px">
            <div style="background:#1a3a2a;padding:20px 24px;border-radius:8px;margin-bottom:20px">
            ...
            <p style="color:#444;line-height:1.7">Thank you po! We received your booking. Our team will contact you at <strong>${phone}</strong> within 24 hours.</p>
            ...
            <div style="background:#fff;border:1px solid #e0e0e0;border-radius:8px;padding:16px;margin-bottom:16px">
              <p style="margin:0 0 10px;font-weight:700;color:#1a3a2a">💳 Payment Options</p>
              ...
              <div style="background:#f5f5f5;padding:12px;border-radius:6px">
                <p style="margin:0;font-weight:700;color:#333">🏦 Bank Transfer</p>
                <p style="margin:4px 0 0;font-size:13px;white-space:pre-line">${PAY.bank}</p>
              </div>
            </div>
            <p style="color:#444;font-size:13px">📱 WhatsApp: <strong>+63 917 123 4567</strong><br>✉️ <strong>stay@bahayniThong.com</strong></p>
          </div>`
        });
  ...
  try {
    ...
    await mailer.sendMail({
      ...
      html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f9f9f9;padding:24px;border-radius:10px">
        ...
        <p style="color:#444">Your booking is <strong>confirmed</strong> po! Please complete your downpayment.</p>
        <div style="background:#c9a84c;border-radius:8px;padding:18px;text-align:center;margin:16px 0">
          <p style="margin:0;color:#1a3a2a;font-size:11px;font-weight:700">DOWNPAYMENT DUE (50%)</p>
